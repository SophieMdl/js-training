[![Build Status](https://travis-ci.org/SophieMdl/js-training.svg?branch=master)](https://travis-ci.org/SophieMdl/js-training)(https://travis-ci.org/nan-academy/js-training)
## Setup
